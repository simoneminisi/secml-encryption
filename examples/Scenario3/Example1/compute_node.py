...
serialized_model_file = open(
    os.path.join("./examples/Scenario3/Example1", "serialized_model.obj"), "rb"
)
...
filehandler = open(
    os.path.join("./examples/Scenario3/Example1", "encrypted_data.obj"), "rb"
)
...
encrypted_data = [
    ts.ckks_vector_from(wrapped_model._context, x) for x in encrypted_data
]
...
filehandler = open(
    os.path.join("./examples/Scenario3/Example1", "encrypted_outputs.obj"), "wb"
)
