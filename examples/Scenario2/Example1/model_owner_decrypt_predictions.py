...
file_encrypted_output = open(os.path.join('./examples/Scenario2/Example1', 'encrypted_outputs.obj'), 'rb') 
...
context = ts.context_from(read_data(os.path.join('./examples/Scenario2/Example1', 'secret.txt')))
