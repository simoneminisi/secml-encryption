...
serialized_model_file = open(os.path.join('./examples/Scenario1/Example2', 'serialized_model.obj'), 'rb') 
...
model.eval()
filehandler = open(os.path.join('./examples/Scenario1/Example2', 'encrypted_data.obj'), 'rb') 
encrypted_data = pickle.load(filehandler)

context = ts.context_from(read_data(os.path.join('./examples/Scenario1/Example2', "public.txt")))
...
filehandler = open(os.path.join('./examples/Scenario1/Example2','encrypted_output.obj'), 'wb') 
