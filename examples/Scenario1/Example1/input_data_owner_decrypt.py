...
file_encrypted_output = open(os.path.join('./examples/Scenario1/Example1', 'encrypted_output.obj'), 'rb') 
encrypted_outputs = pickle.load(file_encrypted_output)

file_target = open(os.path.join('./examples/Scenario1/Example1', 'targets.obj'), 'rb') 
targets = pickle.load(file_target)

correct = 0
total = 0

context = ts.context_from(read_data(os.path.join('./examples/Scenario1/Example1', 'secret.txt')))
