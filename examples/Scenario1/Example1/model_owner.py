...
serialized_model_file = open(os.path.join('./examples/Scenario1/Example1', 'serialized_model.obj'), 'rb') 
...
context = ts.context_from(read_data(os.path.join('./examples/Scenario1/Example1', "public.txt")))
